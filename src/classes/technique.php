...
$techniques = [
    new Technique("dash-tech", "Superdash (Super)", "Superdash", "super-dash.gif"),
    new Technique("dash-tech", "Hyperdash (Hyper)", "Hyperdash"),
    new Technique("dash-tech", "Wavedash", "Wavedash", "wallbouncing.gif"),
    new Technique("dash-tech", "Ultradash (Ultra)", "Ultradash"),
    new Technique("dash-tech", "Demodash (Demo)", "Demodash"),
    new Technique("dash-tech", "Wallbounce (wb)", "Wallbounce", "wavedash.gif"),
    ...
    new Technique("dashless-tech", "Neutral Jump (Neutral)", "Neutral-Jump", "neutral-jumping.gif"),
